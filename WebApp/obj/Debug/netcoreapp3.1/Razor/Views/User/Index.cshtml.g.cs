#pragma checksum "C:\webapplic2\WebApp2\WebApp\Views\User\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "65fff83fa348f52d05ed4633272090761e0f44eb"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"65fff83fa348f52d05ed4633272090761e0f44eb", @"/Views/User/Index.cshtml")]
...
");
#nullable restore
#line 47 "C:\webapplic2\WebApp2\WebApp\Views\User\Index.cshtml"
...
");
#nullable restore
#line 58 "C:\webapplic2\WebApp2\WebApp\Views\User\Index.cshtml"
    }
...
#nullable restore
#line 102 "C:\webapplic2\WebApp2\WebApp\Views\User\Index.cshtml"
...
#nullable disable
            WriteLiteral("\',\r\n           type: \'GET\',\r\n           data: {\r\n               id: ");
#nullable restore
#line 105 "C:\webapplic2\WebApp2\WebApp\Views\User\Index.cshtml"
              Write(Model.Id);
           ...
           let ddl = ' ';
                           $.each(data, function(index, element){
                               ...
                               $.ajax({
                                          url:'");
#nullable restore
#line 118 "C:\webapplic2\WebApp2\WebApp\Views\User\Index.cshtml"
...
#nullable disable
 ...
 $(document).on('click', '.like', function() {
             $.ajax({
               url:'");
#nullable restore
#line 137 "C:\webapplic2\WebApp2\WebApp\Views\User\Index.cshtml"
...
#nullable disable
 ...
 $(document).on('click', '.unlike', function() {
             $.ajax({
               url:'");
#nullable restore
#line 153 "C:\webapplic2\WebApp2\WebApp\Views\User\Index.cshtml"
               Write(Url.Action("LikeButtonResponse", "Post"));
...
#nullable disable
 ...
 $(document).on('click', '#postdata', function() {
                $.ajax({
                  url:'");
#nullable restore
#line 168 "C:\webapplic2\WebApp2\WebApp\Views\User\Index.cshtml"
 ...
 $(document).on('click', '#post-comment', function() {
     ...
     postId = button.data(""id"");
                    $.ajax({
                      url:'");
#nullable restore
#line 186 "C:\webapplic2\WebApp2\WebApp\Views\User\Index.cshtml"
...
#nullable disable
    ...
    let IsLikedByUser = function(postId){ 
     ...
     $.ajax({
        url:'");
#nullable restore
#line 249 "C:\webapplic2\WebApp2\WebApp\Views\User\Index.cshtml"
...
#nullable disable
    ...
    let PostMakeHTML = function(data) {
        ...
        ddl+=           '          <a href=""");
#nullable restore
#line 273 "C:\webapplic2\WebApp2\WebApp\Views\User\Index.cshtml"
...
#nullable disable
        ...
        ddl+=           '                    <a href=""");
#nullable restore
#line 278 "C:\webapplic2\WebApp2\WebApp\Views\User\Index.cshtml"
                                                 Write(Url.RouteUrl(new { controller = "User", action = "Index", id = 0}));
...
");
   ...
   ");
        ...
        ddl+=           '        </div>\n';
        ddl+=           '      ");
            WriteLiteral(@"  <div id=""post-reactions-'+ data.id +'"" style=""margin-bottom: 2%;"">\n';
        ...
        ddl+=           '<div style=""background: #f5f5f5; \n'+
                        ...
                        '</div>' +
                        ' <div id=""comments-end-' + data.id +'"" style=""flex-dire");
    ...
    let CommentMakeHTML = function(data) {
         ...
         ddl+=           '        <div id=""comment-header-'+ data.id +'"" class=""comment-header"" style="" border-bottom: solid; border-bottom-widt");
            WriteLiteral(@"h: 1px; border-bottom-color: #dddddd;"">\n';
         ...
         ddl+=           '                    <a href=""");
#nullable restore
#line 343 "C:\webapplic2\WebApp2\WebApp\Views\User\Index.cshtml"
                                                  Write(Url.RouteUrl(new { controller = "User", action = "Index", id = 0}));
