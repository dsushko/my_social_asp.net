#pragma checksum "C:\webapplic2\WebApp2\WebApp\Views\User\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7b690d1685fe113bb2edd8dbe56d7b820ffaa17c"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7b690d1685fe113bb2edd8dbe56d7b820ffaa17c", @"/Views/User/Index.cshtml")]
...
#nullable disable
        ...
        ddl+=           '            <i class=""fas fa-heart reaction-button '+ ReturnCSSLikeUnlike(IsPostLikedByUser(data.id)) +'"" data-id=""' + data.id  + '"" id=""l'+ data.id +'""></i> <a id=""like-post'+ data.id +'"">'+ data.rating +'</a>\n';
        ...
        ddl+=           '<div style=""background: #f5f5f5; \n'+
                        ...
                        '</div>' +
                        ' <div id=""comments-end-' + data.id +'"" style=""flex-direction: colu");
            WriteLiteral(@"mn;"">' +
                                                '</div>' +
