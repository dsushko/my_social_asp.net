#pragma checksum "C:\project2\WebApplication\WebApp\Views\User\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7f2b6f0a1d6f2acf2165b27cce745bde9cec3b58"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7f2b6f0a1d6f2acf2165b27cce745bde9cec3b58", @"/Views/User/Index.cshtml")]
    ...
    public class Views_User_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\project2\WebApplication\WebApp\Views\User\Index.cshtml"
...
");
#nullable restore
#line 47 "C:\project2\WebApplication\WebApp\Views\User\Index.cshtml"
...
#line hidden
#nullable disable
            WriteLiteral(@"        <div class=""shadow-lg"" style=""width: 100%; height: auto; background: #fff; border-radius: 5px; display: flex"">
...
");
#nullable restore
#line 58 "C:\project2\WebApplication\WebApp\Views\User\Index.cshtml"
    }
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "7f2b6f0a1d6f2acf2165b27cce745bde9cec3b585311", async() => {
            }
            );
...
#nullable restore
#line 102 "C:\project2\WebApplication\WebApp\Views\User\Index.cshtml"
...
#nullable disable
            WriteLiteral("\',\r\n           type: \'GET\',\r\n           data: {\r\n               id: ");
#nullable restore
#line 105 "C:\project2\WebApplication\WebApp\Views\User\Index.cshtml"
              Write(Model.Id);
           ...
           let ddl = ' ';
                           $.each(data, function(index, element){
                               ...
                               $.ajax({
                                          url:'");
#nullable restore
#line 118 "C:\project2\WebApplication\WebApp\Views\User\Index.cshtml"
...
#nullable disable
 ...
 let IsLikedByUser = function(postId){ 
     ...
     $.ajax({
        url:'");
#nullable restore
#line 138 "C:\project2\WebApplication\WebApp\Views\User\Index.cshtml"
...
#nullable disable
 ...
 let PostMakeHTML = function(data) {
        let ddl = ' '; 
        ddl+='<div id=""post-'+ data.id +'"" class=""shadow-lg"" style=""width: 100%; border-radius: 2px; margin-top: 2%;"">\n';
        ...
        ddl+=           '                    <a href=""");
#nullable restore
#line 165 "C:\project2\WebApplication\WebApp\Views\User\Index.cshtml"
...
#nullable disable
        ...
        ddl+=               ConvertTimeToPostFormat(data.date);
        ddl+=           '                </div>\n';
        ddl+=           '            </div>\n';
 ...
 ");
        ...
        ddl+=           '    ");
            WriteLiteral(@"        <i class=""fas fa-heart reaction-button '+ ReturnLikeUnlike(IsLikedByUser(data.id)) +'"" data-id=""' + data.id  + '"" id=""l'+ data.id +'""></i> <a id=""like'+ data.id +'"">'+ data.rating +'</a>\n';
        ...
        ddl+=           '<div style=""background: #f5f5f5; \n'+
                        ...
                        ' <div id=""comments-end-' + data.id +'"" style=""flex-direction: column;"">' +
                                                '</div>' +
                      ");
            WriteLiteral(@"  '   <div style=""display:flex; flex-direction: row; width:100%; align-items: flex-start"">' +
 ...
 let CommentMakeHTML = function(data) {
         ...
         ddl+=           '            <img src=""' + data.owner.a");
            WriteLiteral(@"vatarPath + '"" width=""40px"" height=""40px"" style=""border-radius: 50% "">\n';
         ddl+=           '            <div style=""padding: 1px;  margin-left: 10px;"">\n';
         ddl+=           '                <div style=""color: #20257c; font-size: 15px;"">\n';
         ddl+=           '                    <a href=""");
#nullable restore
#line 230 "C:\project2\WebApplication\WebApp\Views\User\Index.cshtml"
                                                  Write(Url.RouteUrl(new { controller = "User", action = "Index", id = 0}));
...
#nullable disable
 ...
 $(document).on('click', '.like', function() {
             $.ajax({
               url:'");
#nullable restore
#line 246 "C:\project2\WebApplication\WebApp\Views\User\Index.cshtml"
...
#nullable disable
 ...
 $(document).on('click', '.unlike', function() {
             $.ajax({
               url:'");
#nullable restore
#line 262 "C:\project2\WebApplication\WebApp\Views\User\Index.cshtml"
               Write(Url.Action("LikeButtonResponse", "Post"));
...
#nullable disable
 ...
 $(document).on('click', '#postdata', function() {
                $.ajax({
                  url:'");
#nullable restore
#line 277 "C:\project2\WebApplication\WebApp\Views\User\Index.cshtml"
 ...
 $(document).on('click', '#post-comment', function() {
     ...
     postId = button.data(""id"");
                    $.ajax({
                      url:'");
#nullable restore
#line 295 "C:\project2\WebApplication\WebApp\Views\User\Index.cshtml"
 ...
 $(document).on('click', '#delete-post', function() {
   DeletePost($(this).data(""id""));
    ...
    let DeletePost = function(id) {
        ...
        url:'");
#nullable restore
#line 343 "C:\project2\WebApplication\WebApp\Views\User\Index.cshtml"
